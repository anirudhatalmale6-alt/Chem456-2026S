...
{%- if module.slides %} [[pptx](https://github.com/daveminh/Chem456-2026S/raw/main/slides/{{ module.basename }}.pptx)/[pdf](https://github.com/daveminh/Chem456-2026S/raw/main/slides/{{ module.basename }}.pdf)]. {% endif %}
