...
{%- if module.slides %} [[pptx](https://github.com/daveminh/Chem456-2026S/raw/main/slides/{{ module.slides }}.pptx)/[pdf](https://github.com/daveminh/Chem456-2026S/raw/main/slides/{{ module.slides }}.pdf)]. {% endif %}
